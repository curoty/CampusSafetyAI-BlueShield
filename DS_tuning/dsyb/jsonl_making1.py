...
class ProjectTrainingDataGenerator:
    ...
    def generate_qa_pairs(self):
        ...
        for question_key, question_data in all_questions.items():
            core_question = question_data["core_question"]
            ...
            for question, answer in combinations:
                ...
                # 对于身份问题，使用专门的instruction
                if question_key == "assistant_identity":
                    instruction = "你是本项目的摔倒检测告警助手，请进行自我介绍"
                else:
                    instruction = f"你是本项目的AI助手，请回答关于{core_question}的问题"
...
def main():
    ...
    total_size, train_size, val_size = generator.save_dataset(
        all_data, "extended_project_training_data.json"
    )
